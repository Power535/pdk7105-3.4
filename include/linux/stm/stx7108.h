...
struct stx7108_pwm_config {
	struct stm_plat_pwm_out_channel_config out_channel_config[2];
	struct stm_plat_pwm_capt_channel_config capt_channel_config[2];
};
void stx7108_configure_pwm(struct stx7108_pwm_config *config);

void stx7108_configure_lpm(struct stm_plat_lpm_data *board_info);
