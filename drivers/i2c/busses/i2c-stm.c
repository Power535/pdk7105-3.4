...
#define REP_START_HOLD_TIME_NORMAL    4500
#define START_HOLD_TIME_NORMAL        4500
#define REP_START_SETUP_TIME_NORMAL   5300
#define DATA_SETUP_TIME_NORMAL         300
#define STOP_SETUP_TIME_NORMAL        8000
#define BUS_FREE_TIME_NORMAL          5000

#define REP_START_HOLD_TIME_FAST       660
#define START_HOLD_TIME_FAST           660
#define REP_START_SETUP_TIME_FAST      660
#define DATA_SETUP_TIME_FAST           110
#define STOP_SETUP_TIME_FAST           660
...
static void iic_stm_setup_timing(struct iic_ssc *adap)
{
	...
	iic_glitch_width = HW_GLITCH_CLK_WIDTH;
	iic_glitch_width_dataout = HW_GLITCH_DATA_WIDTH;
