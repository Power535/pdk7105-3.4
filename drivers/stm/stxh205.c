...
struct sysconf_field *sc_chip_id;
void __init stxh205_early_device_init(void)
{
	...
	sc_chip_id = sysconf_claim(SYSCONF(41), 0, 31, "devid");
	devid = sysconf_read(sc_chip_id);
	...
	case 0x057:
		...
		boot_cpu_data.variant = CPU_VARIANT_ST40_STXH273;
		variant = "273";
		break;
	case 0x58:
		/* STxH237 (Cardiff 2): devid 0x0d458041 */
		boot_cpu_data.type = CPU_STXH237;
		boot_cpu_data.variant = CPU_VARIANT_ST40_STXH237;
		variant = "237";
		break;
	default:
