...
/* command id to inform host for FP PIO/alarm reset ack */
...
#define LPM_PATCH_SOFT_VER	3
#define LPM_BUILD_MONTH		1
#define LPM_BUILD_DAY           0x9
...
/* Macro to fill lpm_internal_send_msg struct field */
